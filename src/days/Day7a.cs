...
{
    public partial class Day7a : IDay
    {
        ...
        public struct Hand(int bid, string cards)
        {
            ...
            public HandType HandType { get; private set; } = GetHandType(cards);
            public int Rank { get; private set; } = GetHandTypeRank(GetHandType(cards));
